...
print(f"\n{'='*60}")
print(f"Backtest visualization saved to: backtest_result.png")
print(f"{'='*60}\n")
print(f"Strategy Statistics:")
print(f"  Final Return: {df_mrvb['cumulative_return'].iloc[-1]:.2f}x")
print(f"  Max Drawdown: {df_mrvb['drawdown_strategy'].min()*100:.2f}%")
print(f"\nBTC Hold Statistics:")
print(f"  Final Return: {df['btc_hold'].iloc[-1]:.2f}x")
print(f"  Max Drawdown: {df['drawdown_btc'].min()*100:.2f}%")
print(f"{'='*60}\n")
plt.show()
